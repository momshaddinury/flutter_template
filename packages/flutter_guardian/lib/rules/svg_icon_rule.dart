...
/// generated `Assets.icons` entry, and renders through the `AppIcon`
/// widget — the one file allowed to touch `flutter_svg`.
///
/// Flags an import of `flutter_svg` anywhere but `app_icon.dart`, and a
/// `.svg` string literal anywhere in presentation but `app_icon.dart` and
...
class SvgIconRule extends AnalysisRule {
  SvgIconRule()
    : super(
        name: 'svg_outside_app_icon',
        description:
            'SVG assets render through the AppIcon widget, never directly.',
      );

  static const LintCode code = LintCode(
    'svg_outside_app_icon',
    'SVG assets render through the AppIcon widget, never directly.',
    correctionMessage:
  ...
  static const String _sanctionedFile =
      '/lib/src/presentation/core/widgets/app_icon.dart';
...
class _Visitor extends SimpleAstVisitor<void> {
  ...
  void visitImportDirective(ImportDirective node) {
    ...
    // WHY: the generated assets file wraps flutter_svg on AppIcon's
